...
export default function App() {
  ...
  return (
    <div className={`wrapper ${torchEquipped && "relative no-cursor"}`} onMouseUp={() => setTorchEquipped(false)}>
     ...
     <div className={`wood-container ${kindleClass}`} onMouseEnter={() => setWoodKindling(true)}  onMouseLeave={() => setWoodOnFire(true)}>
          🪵
